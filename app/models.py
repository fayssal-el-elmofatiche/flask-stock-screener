...
class User(db.Model):
    ...
    stocks: so.WriteOnlyMapped['StockScreener'] = so.relationship(back_populates='screener')
...
class Stock(db.Model):
    ...
    screeners: so.WriteOnlyMapped['StockScreener'] = so.relationship(back_populates='screener')
